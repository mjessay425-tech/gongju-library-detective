...
const dialogueData={
  0:{tx:135,ty:468,tw:590,th:150,text:'명탐정 냥냥에게 의뢰가 도착했냥!\n공주에 숨겨진 도서관을 찾아보자!',size:19},
  1:{tx:325,ty:1020,tw:405,th:160,text:'여기가 우리 수사의 시작점!\n공주목!\n여기서 어떻게 가야될까?',size:15},
  2:{tx:235,ty:595,tw:380,th:220,text:'혹시 공주도서관을 찾고있니?\n내가 가는 길을 잘 아는데!\n간판 자음에 ‘ㄱㅈㅈ’이\n있는 곳으로 가봐!',size:15},
  3:{tx:330,ty:1075,tw:400,th:130,text:'어? 이쪽으로 가면\n공주도서관으로 갈 수 있나?',size:15},
  4:{tx:375,ty:955,tw:370,th:125,text:'흠..! 예쁜 주택이 보이네!\n파란색 주소 표지판에\n적힌 숫자는 무엇일까?',size:15},
  5:{tx:335,ty:1135,tw:430,th:115,text:'오른쪽 위! 공주도서관이 보여!\n잘 가고 있는 것 같아.',size:15},
  6:{tx:372,ty:780,tw:270,th:210,text:'어느 쪽으로 가야\n도서관이 나올까?\n표지판 퍼즐을 맞춰\n단서를 찾아보자냥!',size:15},
  7:{tx:345,ty:1035,tw:370,th:135,text:'나무 표지판에\n써진 글자를 읽어보자냥!\n정답을 입력해봐!',size:15},
  9:{tx:338,ty:1068,tw:425,th:155,text:'벽에 해바라기 그림이\n그려져 있네! 🌻\n해바라기는 모두 몇 개일까?\n정답을 입력해봐!',size:15},
  10:{tx:330,ty:1165,tw:420,th:150,text:'조금 더 가다가 오른쪽을 보니까\n계단이 보여!\n공주도서관으로 가는 길일까?',size:14},
  ...
  13:{tx:300,ty:735,tw:315,th:105,text:'와! 정말 도착했잖아!\n너 정말 명탐정이다!',size:15},
  14:{tx:345,ty:1073,tw:400,th:175,text:'드디어 도착했어!\n하지만 이 간판에 적힌 글이\n중요한 단서일지도 몰라!\n무엇이 쓰여 있나 맞춰보자냥!',size:15},
...
function render(){
  ...
  if(idx===1){ zone(s,194,1406,435,240,showNext,40,853,1844); return; }
  if(idx===2){
...
function renderPuzzle(s){
  ...
  const pieces=[
   {src:'puzzle-1.png',x:412,y:1340,w:139,h:146},
   {src:'puzzle-2.png',x:590,y:1340,w:183,h:146},
